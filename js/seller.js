...
const productListingElement = document.querySelector('.product-lisnting');
...
applyFormButton.addEventListener('click', () => {
    if(!businessName.value.lenght || !address.value.lenght || !about.value.lenght || !number.value.lenght){
        showAlert('fill all the inputs');
    } else if(!tac.checked || !legitInfo.checked){
        showAlert('you must agree to our terms and condicions');
    } else{
